...
\subsubsection{Falls $|a| = 1$}
$x=0$ wird \emph{Zentrum} genannt. Ist $x = 1$, so ist jeder Punkt $x\in\RR$ ein Gleichgewichtspunkt. F"ur $x=-1$ ergeben sich 2-periodische Orbits (gez"ahlt an der minimalen positiven Periode).
