...
\begin{beispiel}
\[\lambda\in\mathbb{R}, \Psi(\lambda,\cdot), \begin{cases}
x_1\mapsto x_1+\lambda x_1+x_1^2+x_2^3\\
x_2\mapsto \frac 1 2 x_2+x_1^2+x_2^2
\end{cases}\]
$C^{\infty}$-glatt\\
$\Psi(\lambda,0)=0\ \forall\lambda\in\mathbb{R} \Rightarrow$ Grundl"osungszweig trivialer (Fix-) Gleichgewichtspunkte\\
\[\operatorname{J}_x(\lambda,x)=\begin{pmatrix}
...
Eigenvektor zu $\gamma(\lambda)=1+\lambda: \varphi(\lambda)=(1,0)\ \forall \lambda\in\mathbb{R}$\\
insbesondere $\varphi =\varphi(\lambda_c)=\varphi(0)=(1,0)$\\
Ferner gilt: $\operatorname{J}_x\Psi(\lambda,0)^T=\operatorname{J}_x\Psi(\lambda,0)$ symmetrische Matrix\\
