...
\begin{definition}
Ein Verzweigungspunkt $(\lambda_C, x_C)$ hei"st \emph{transkritisch}, falls in jeder hinreichend kleinen Umgebung $U$ von $(\lambda_C, x_C)$ Parameter $\lambda_- \leq \lambda_C \leq \lambda_+$ und Anfangswerte $x_+, x_- \in \RR$ existieren, sodass $(x_- - x)(x_+ - x) < 0$ und 
